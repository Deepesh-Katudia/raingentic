...
export function x402Config() {
  return {
    ...
    // EIP-712 domain of the asset contract, required to sign the EIP-3009
    // transferWithAuthorization payment. Read onchain via the asset's own
    // name()/version() — verified for the default testnet USDC on 2026-08-09.
    assetName: opt("X402_ASSET_NAME", "USDC"),
    assetVersion: opt("X402_ASSET_VERSION", "2"),
